		...
		return (
			<div className="mailing">
				...
				<Container fluid className="mailing-content">
					<Row>
						<p>
							Our mailing list is a great way to stay up to date on our events.
							We send weekly emails that include upcoming event details,
							features regarding past and future speakers, and other happenings
							at the Forum. If you’re interested in signing up, fill out the
							form below.
						</p>
					</Row>
				</Container>
